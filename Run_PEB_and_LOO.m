...
% The first section runs BMR on the estimated full models and generates the
% results displayed in Figure 3.

% The second section runs a PEB model containing a parameter to quantify
% the effects of PTQ scores on each of the DCM modulatory {'B'} pathways.
% vmPFC-to-MD modulatory effects are tested using leave-one-out cross
% validation to generate the results depicted in Figure 4.
